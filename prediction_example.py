...
k = int(min(graphA.number_of_nodes(), graphA.number_of_edges()) * 1)
f = lp.fit_link_prediction_function(graphA, graphB, funcs.exponential_odd, k=k, verbose=True) # TODO: find a better way to set k
